...
Em Haskell: \passthrough{\lstinline!type Env = Map String Int!}
\end{frame}
...
\item
  ...
  \passthrough{\lstinline!x * 4!}
\item
  O valor de \passthrough{\lstinline!x!} só é conhecido durante a
  execu\c{c}\~{a}o
\end{itemize}
\end{frame}
...
\tightlist
\item
  Small-Step: \passthrough{\lstinline!x := 2 + 3; print x * 4!}
...
\begin{frame}{Deriva\c{c}\~{a}o: \passthrough{\lstinline!x := 2 + 3!}}
...
\begin{frame}{Deriva\c{c}\~{a}o: \passthrough{\lstinline!x := 2+3; print x*4!}}
...
\item
  ...
  \tightlist
  \item
    \passthrough{\lstinline!StateT Env!}: o ambiente \(\sigma\)
    implícito --- lido com \passthrough{\lstinline!get!}, modificado com
    \passthrough{\lstinline!modify!}
  \item
    \passthrough{\lstinline!ExceptT String!}: tratamento de erros
    (variável n\~{a}o definida)
  \item
    \passthrough{\lstinline!IO!}: efeitos de I/O para
    \passthrough{\lstinline!read!} e \passthrough{\lstinline!print!}
  \end{itemize}
\end{itemize}
\end{frame}

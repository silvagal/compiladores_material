...
\item
  A fun\c{c}\~{a}o \texttt{finals} retorna
...
\item
  Estado \texttt{False}: último caractere n\~{a}o foi
  \texttt{1} (ou início)
\item
...
\item
  ...
  \texttt{:@:}) refletem a nota\c{c}\~{a}o matemática
\item
...
\begin{frame}[fragile]{A Fun\c{c}\~{a}o \texttt{thompson} em
Haskell}
...
\item
  Evita ambiguidades sem\^{a}nticas: \texttt{>=} n\~{a}o deve

...
\hypertarget{o-algoritmo-ll1}{%
\section{O Algoritmo LL(1)}\label{o-algoritmo-ll1}}
...
\tightlist
\item
  \passthrough{\lstinline!fixedPoint step initial!}: aplica
  \passthrough{\lstinline!step!} repetidamente até converg\^{e}ncia
\item
  Cada itera\c{c}\~{a}o pode expandir os conjuntos FIRST
\end{itemize}
\end{frame}

\begin{frame}[fragile]{\passthrough{\lstinline!firstForSequence!}:

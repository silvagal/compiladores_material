\subtitle{\bf Aula 22 - Introdu\c{c}\~{a}o}
\begin{frame}[t,plain]
\titlepage
\end{frame}
...
\begin{quote}
Se uma fun\c{c}\~{a}o espera \texttt{Number} e fornecemos um
...
Gra\c{c}as \`{a} subsun\c{c}\~{a}o: se os ramos de um \texttt{if} t\^{e}m
...
Se \(C \not<: D\): lan\c{c}a \texttt{ClassCastException}

...
\item
  Código alvo pode ser uma linguagem de baixo nível (compila\~{c}ão).
\end{itemize}
\end{frame}
...
\begin{itemize}
\item
  Qual o problema da compila\~{c}ão?
\item
  Imagine a situação:
...
\begin{itemize}
\item
  Introduçãoo ao processo de compila\~{c}ão e interpretação
\item
  Análise léxica
\item
  Análise sintática
...
\item
  Trabalhos que apresentarem qualquer erro de compila\~{c}ão neste ambiente,

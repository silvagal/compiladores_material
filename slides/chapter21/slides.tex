\subtitle{\bf Aula 21 - Introdu\c{c}\~{a}o}
\begin{frame}[t,plain]
\titlepage
\end{frame}
...
\begin{enumerate}
\item
  \textbf{Infer\^{e}ncia}: tipo \texttt{Int}, árvore tipada
...
\item
  ...
  \texttt{lam\_1} (aplica\c{c}\~{a}o de
  \texttt{f})
\item
  \textbf{Execu\c{c}\~{a}o TImp}: imprime \texttt{42}
\end{enumerate}
\end{frame}

...
\hypertarget{a-linguagem-while}{%
\section{A Linguagem While}\label{a-linguagem-while}}
...
\passthrough{\lstinline!while i < 3 do \{ i := i + 1 \}!}
...
O comando \passthrough{\lstinline!return!} interrompe a execu\c{c}\~{a}o normal.
Modelamos isso com:
...
\item
  \({\uparrow}\, v\): \passthrough{\lstinline!return!} executado, \(v\)
...
\item
  ...
  \passthrough{\lstinline!return!}; (CallExpr) executa em ambiente
  fresco.
\end{itemize}
\end{frame}

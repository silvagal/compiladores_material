...
\item
  Exemplo: \passthrough{\lstinline!if!}, \passthrough{\lstinline!(!},
  \passthrough{\lstinline!val!}, \passthrough{\lstinline!>=!},
  \passthrough{\lstinline!0!}, \passthrough{\lstinline!)!},
  \passthrough{\lstinline!pos!}, \passthrough{\lstinline!=!},
...
\item
  ...
  \passthrough{\lstinline![rbp - offset]!}
\item
  Estruturas de controle substituídas por desvios
  (\passthrough{\lstinline!jge!}, \passthrough{\lstinline!jne!},
  \passthrough{\lstinline!jmp!})
\end{itemize}
\end{frame}
...
\tightlist
\item
  Variáveis em registradores (\passthrough{\lstinline!rcx!},
  \passthrough{\lstinline!rdx!}, \passthrough{\lstinline!rax!})
\item
...
\midrule\noalign{}
\endhead
Linker & Múltiplos \passthrough{\lstinline!.o!} & Executável & Resolve
refer\^{e}ncias \\

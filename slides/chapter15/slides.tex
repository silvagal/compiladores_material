...
\begin{frame}{Alguns Casos}
    ...
    \(\vdash t_1' : \mathbf{Bool}\). Aplicando (T-If): \(\vdash t' : T\). \checkmark{}
\end{frame}
...
\begin{frame}{Alguns Casos}
    ...
    \(\vdash \mathbf{succ}\ t_1' : \mathbf{Nat}\). \checkmark{}
\end{frame}
...
\begin{frame}{Alguns Casos}
    ...
    \emph{Casos} (T-True), (T-False), (T-Zero): \(t\) já é valor. \checkmark{}
\end{frame}
...
\begin{frame}{Alguns Casos}
    ...
    \begin{itemize}
        ...
        \item
        Se \(t_1 \to t_1'\): aplica-se (E-If). \checkmark{}
        \item
        ...
        \begin{itemize}
            ...
            \item
            \(t_1 = \mathbf{true}\): aplica-se (E-IfTrue). \checkmark{}
            \item
            \(t_1 = \mathbf{false}\): aplica-se (E-IfFalse). \checkmark{}
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Alguns Casos}
    ...
    \begin{itemize}
        ...
        \item
        \(t_1 \to t_1'\): aplica-se (E-Succ). \checkmark{}
        \item
        \(t_1\) é valor de tipo \(\mathbf{Nat}\): pela unicidade, \(t_1\) é
        \(nv\). Logo \(\mathbf{succ}\ nv\) é valor numérico. \checkmark{}
    \end{itemize}
\end{frame}
...
\begin{frame}{Alguns Casos}
    ...
    \begin{itemize}
        ...
        \item
        \(t_1 \to t_1'\): aplica-se (E-Pred). \checkmark{} \textbar{}
        \(nv = \mathbf{0}\): (E-PredZero). \checkmark{} \textbar{}
        \(nv = \mathbf{succ}\ nv_1\): (E-PredSucc). \checkmark{}
    \end{itemize}
\end{frame}

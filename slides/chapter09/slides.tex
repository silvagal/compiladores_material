...
\begin{frame}[fragile]{Trace Shift-Reduce para
    ...
    \begin{table}
        \begin{tabular}{l l l l}
            ...
            Pilha & Entrada & Ação \\
            \hline
            \texttt{S+2} & \verb|$| & reduce
            \(E \to n\) \\
            \texttt{S+E} & \verb|$| & reduce
            \(S \to S+E\) \\
            \texttt{S} & \verb|$| &
            \textbf{aceitar} \\
            \hline
...
\begin{frame}[fragile]{Estados LR(0)}
    ...
    \begin{lstlisting}
        data Item = Item
        { itemLHS    :: String    -- A: n\~ao-terminal
        , itemBefore :: [Symbol]  -- \alpha{}: antes do ponto
        , itemAfter  :: [Symbol]  -- \beta{}: depois do ponto
        }
...
\begin{frame}[fragile]{Regras de Preenchimento LR(0)}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item
            \texttt{action[i, t] = Reduce(A -> \alpha{})} para
...
\begin{frame}[fragile]{A Solução SLR}
    ...
    \begin{itemize}
        ...
        \texttt{+})
        \item
        SLR: insere reduce apenas em \verb|$| e
